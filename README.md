...
|------|--------|-----------|
| Архитектура и настройка | ✅ | 100% |
| База данных и модели | 🟡 | 80% |
| Генерация текста (GigaChat) | 🟡 | 70% |
| Генерация изображений (Kandinsky) | 🟡 | 60% |
| Веб-интерфейс | 🟡 | 75% |
| Интеграция и отправка | 🔴 | 40% |
| Тестирование и документация | 🔴 | 30% |
...
**Разработано для хакатона ОПД 2024**  
